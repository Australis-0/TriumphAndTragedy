  ...
  */
  createPops: function (arg0_province, arg1_options) {
    ...
    try {
      ...
      var population = module.exports.getProvincePopulation(province_obj.id);
      ...
      for (var i = 0; i < all_pop_chances.length; i++) {
        ...
        if (!options.age) {
          if (options.initialise) {
            ...
            var oefr = 0;
            var pop_fertile_women = module.exports.getProvinceFertileWomen(province_obj.id);
            ...
            for (var x = 0; x < all_pops.length; x++) {
              ...
              oefr += returnSafeNumber(module.exports.getPopOEFR(province_obj.id, all_pops[x]));
