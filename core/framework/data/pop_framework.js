      ...
      for (var i = 0; i < all_pop_chances.length; i++) {
        ...
        if (options.age) {
          ...
          if (!options.education_level.mean) {
            ...
            for (var x = 0; x < max; x++)
              modifyValue(province_obj.pops, `b_${Math.floor(current_year + 1)}`, population_change*local_percentage);
          } else {
            ...
            for (var x = 0; x < all_age_distribution_keys.length; x++) {
              ...
              modifyValue(province_obj.pops, `b_${parseInt(all_age_distribution_keys[x]) + min}`, population_change*local_percentage);
            }
          }
        }
