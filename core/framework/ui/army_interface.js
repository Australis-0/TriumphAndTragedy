  ...
  printArmy: function (arg0_user, arg1_army_name) {
    ...
    if (army_obj) {
      ...
      //Format Page 1 - army_string
      {
        ...
        army_string.push(`${config.icons.provinces} Current Province: **${army_obj.province}** (${config.icons.railways} Supply Limit: **${parseNumber(Math.ceil(returnSafeNumber(lookup.province_troop_strengths[army_obj.province])/1000))}/${parseNumber(returnSafeNumber(province_obj.supply_limit, config.defines.combat.base_supply_limit))}**)`);
