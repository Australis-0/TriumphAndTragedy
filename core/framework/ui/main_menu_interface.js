module.exports = {
  ...
  initialiseResign: function (arg0_user) {
    ...
    returnChannel(game_obj.channel).send("Loading ..").then((msg) => {
      confirmDialogue(msg, {
        text: "**Resign**\n\nAre you sure you wish to abandon this nation? If no other players are on this nation, it will be permanently abandoned and you will not be able to pick it again!",
        user: game_obj.user,
        delete_after: true
      }, function () {
