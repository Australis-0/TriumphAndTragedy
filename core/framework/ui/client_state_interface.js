module.exports = {
  ...
  initialiseClientStateScreen: function (arg0_user, arg1_client_state) {
    ...
    if (returnSafeNumber(infamy_reduction) > 0) {
      client_string.push("");
      client_string.push(`- Releasing this client state will reduce our infamy by **${parseNumber(infamy_reduction, { display_float: true })}** for **${parseNumber(getInfamyLossPerProvince(user_id), { display_float: true })}** per province.`);
    }
