module.exports = {
            ...
            if (!isNaN(building_amount)) {
              ...
              if (usr.available_buildings.includes(raw_building_name)) {
                ...
                if (!building_category.hidden) {
                  ...
                  printError(game_obj.id, `You are not able to construct these types of buildings, as they are currently disabled.`);
                }
              } else {
  ...
  initialiseMassBuild: function (arg0_user) {
    //Convert from parameters
    var user_id = arg0_user;
    ...
    visualPrompt(game_obj.alert_embed, user_id, {
      title: `Mass Build:`,
      prompts: [
        [`How many buildings of this type would you like to mass construct?`, "number", { min: 1 }],
        [`What type of building would you like to construct?\n\nType **[View Buildings]** for a full list of buildings you can construct.`, "string"],
        [`Which provinces would you like to construct these buildings in? Separate each province with a space (e.g. '4701 4702 4705').`, "string"]
      ]
    },
    function (arg) {
      module.exports.massBuild(user_id, arg[2].trim().split(" "), arg[0], arg[1])
    },
    function (arg) {
      switch (arg) {
        case "view buildings":
  ...
  massBuild: function (arg0_user, arg1_provinces, arg2_amount, arg3_building_name) {
    //Convert from parameters
    var user_id = arg0_user;
    ...
    //Iterate over provinces and call build()
    for (var i = 0; i < provinces.length; i++)
      module.exports.build(user_id, provinces[i], amount, building_name);
  }
};
