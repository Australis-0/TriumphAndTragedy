config.national_modifiers.supply_modifiers = {
  ...
  surplus_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is quite good. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  good_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is good. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  decent_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is okay. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  strained_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is somewhat impacted. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  poor_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is poor. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  problematic_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is severely impacted. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  abysmal_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is close to breaking point. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  breakdown_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and combat efficacy is near-nonexistent. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
  ...
  nonexistent_supply_situation: {
    ...
    icon: "refined_petroil",
    description: "Supply affects our military's ability to fight in battle through something called **combat efficacy**, which affects both Attack and Defence. Units lacking supply will have lower combat efficacy than those that don't.\n\nOur army's overall supply situation is estimated at **{LOCAL.overall_supply}** and our units will likely melt on contact with the enemy. A more detailed breakdown by military branch can be found below:\n\n{LOCAL.supply_localisation}\n\n{LOCAL.deficit_localisation}",
