...
config.technology.administrative_technology = {
  ...
  the_courthouse: {
    name: "The Courthouse",
    icon: config.icons.political_capital,
  ...
  absolutism: {
    name: "Absolutism",
    icon: config.icons.government_scroll,
  ...
  colonial_autonomy: {
    ...
    icon: config.icons.consciousness,
